...
class RateLimiter:
    """
    Rate limiter to prevent attackers from abusing ShellGuard to launch DDoS attacks.

    Prevents abuse where malicious actors attempt to use ShellGuard commands
