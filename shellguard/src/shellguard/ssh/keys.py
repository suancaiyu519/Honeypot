...
def getRSAKeys() -> tuple[bytes, bytes]:
    ...
    """
    try:
        publicKeyFile: str = ShellGuardConfig.get("ssh", "rsa_public_key")
        privateKeyFile: str = ShellGuardConfig.get("ssh", "rsa_private_key")
...
def getECDSAKeys() -> tuple[bytes, bytes]:
    ...
    """
    try:
        publicKeyFile: str = ShellGuardConfig.get("ssh", "ecdsa_public_key")
        privateKeyFile: str = ShellGuardConfig.get("ssh", "ecdsa_private_key")
    except (NoOptionError, NoSectionError):
...
def geted25519Keys() -> tuple[bytes, bytes]:
    ...
    """
    try:
        publicKeyFile: str = ShellGuardConfig.get("ssh", "ed25519_public_key")
        privateKeyFile: str = ShellGuardConfig.get("ssh", "ed25519_private_key")
    except (NoOptionError, NoSectionError):
