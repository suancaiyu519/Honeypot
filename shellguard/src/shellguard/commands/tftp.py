...
from shellguard.shell.customparser import CustomParser, OptionNotFound
...
class Command_tftp(HoneyPotCommand):
    ...
    file_to_get: str
    limit_size = ShellGuardConfig.getint("honeypot", "download_limit_size", fallback=0)
