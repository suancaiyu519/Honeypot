...
from shellguard.llm.llm import LLMClient
...
class HoneyPotBaseProtocol(insults.TerminalProtocol, TimeoutMixin):
    ...
    def connectionMade(self) -> None:
        ...
        timeout = ShellGuardConfig.getint("honeypot", "interactive_timeout", fallback=180)
    ...
    def lineReceived(self, line: bytes) -> None:
        ...
        log.msg(eventid="shellguard.command.input", input=string, format="CMD: %(input)s")
