...
class LLMClient:
    ...
    def __init__(self) -> None:
        ...
        self.api_key = ShellGuardConfig.get("llm", "api_key", fallback="")
        self.model = ShellGuardConfig.get("llm", "model", fallback="gpt-4o-mini")
        self.host = ShellGuardConfig.get("llm", "host", fallback="https://api.openai.com")
        self.path = ShellGuardConfig.get("llm", "path", fallback="/v1/chat/completions")
        self.max_tokens = ShellGuardConfig.getint("llm", "max_tokens", fallback=500)
        self.temperature = ShellGuardConfig.getfloat("llm", "temperature", fallback=0.7)
        self.debug = ShellGuardConfig.getboolean("llm", "debug", fallback=False)
