...
from shellguard.llm import server
from shellguard.llm import session as llmsession
...
components.registerAdapter(llmsession.SSHSessionForShellGuardUser, ShellGuardUser, ISession)
