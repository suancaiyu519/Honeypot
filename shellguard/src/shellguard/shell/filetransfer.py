...
from shellguard.shell import pwd
from shellguard.core.config import ShellGuardConfig


@implementer(ISFTPFile)
class ShellGuardSFTPFile:
    """
    SFTPTFile
    """
...
class SFTPServerForShellGuardUser:
    ...
    def openFile(self, filename, flags, attrs):
        ...
        return ShellGuardSFTPFile(self, self._absPath(filename), flags, attrs)
    ...
    def openDirectory(self, path):
        ...
        return ShellGuardSFTPDirectory(self, self._absPath(path))
