...
interaction with main ShellGuard, from the logic to create guests in a low-level perspective, we hope to ease development
...
Internet access, and creating a "shellguard" network in libvirt.
