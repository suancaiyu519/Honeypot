...
class UserDB:
    ...
    def load(self) -> None:
        ...
        try:
            with open(
                "{}/userdb.txt".format(ShellGuardConfig.get("honeypot", "etc_path")),
                encoding="ascii",
            ) as db:
...
class AuthRandom:
    ...
    def __init__(self) -> None:
        ...
        try:
            parameters: str = ShellGuardConfig.get("honeypot", "auth_class_parameters")
        ...
        self.uservar_file: str = "{}/auth_random.json".format(
            ShellGuardConfig.get("honeypot", "state_path")
        )
        self.loadvars()
    ...
    def savevars(self) -> None:
        ...
        """
        data = self.uservar
        # Note: this is subject to races between shellguard logins
