...
class HoneyPotFilesystem:
    def __init__(self, arch: str, home: str) -> None:
        ...
        try:
            with open(ShellGuardConfig.get("shell", "filesystem"), "rb") as f:
        ...
        # contents:
        try:
            self.init_honeyfs(ShellGuardConfig.get("honeypot", "contents_path"))
        except Exception as e:
    ...
    def get_path(self, path: str, follow_symlinks: bool = True) -> Any:
        """
        This returns the ShellGuard file system objects for a directory
        """
    ...
    def getfile(self, path: str, follow_symlinks: bool = True) -> list[Any] | None:
        """
        This returns the ShellGuard file system object for a path
        """
        if path == "/":
            return self.fs
    ...
    def open(self, filename: str, openFlags: int, mode: int) -> int | None:
        ...
        if openFlags & os.O_WRONLY == os.O_WRONLY or openFlags & os.O_RDWR == os.O_RDWR:
            ...
            hostfile: str = "{}/{}_sftp_{}".format(
                ShellGuardConfig.get("honeypot", "download_path"),
    ...
    def close(self, fd: int) -> None:
        ...
        if self.tempfiles[fd] is not None:
            ...
            shasumfile: str = (
                ShellGuardConfig.get("honeypot", "download_path") + "/" + shasum
            )
            ...
            log.msg(
                ...
                eventid="shellguard.session.file_upload",
