...
from shellguard.telnet_proxy import client_transport
from shellguard.telnet_proxy.handler import TelnetHandler
...
class FrontendTelnetTransport(TimeoutMixin, TelnetTransport):
    ...
    def connectionMade(self):
        ...
        if proxy_backend == "pool":
            ...
            backend_ip = ShellGuardConfig.get("proxy", "backend_telnet_host")
            backend_port = ShellGuardConfig.getint("proxy", "backend_telnet_port")
