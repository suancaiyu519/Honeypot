...
from shellguard.shell import protocol
...
class LoggingServerProtocol(insults.ServerProtocol):
    ...
    ttylogPath: str = ShellGuardConfig.get("honeypot", "ttylog_path", fallback=".")
    downloadPath: str = ShellGuardConfig.get("honeypot", "download_path", fallback=".")
    ttylogEnabled: bool = ShellGuardConfig.getboolean("honeypot", "ttylog", fallback=False)
