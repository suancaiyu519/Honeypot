...
from shellguard.core import credentials as conchcredentials
from shellguard.core.config import ShellGuardConfig
import shellguard.core.auth  # noqa: F401
...
class HoneypotPublicKeyChecker:
    ...
    def requestAvatarId(self, credentials):
        ...
        log.msg(
            eventid="shellguard.client.fingerprint",
        ...
        if ShellGuardConfig.getboolean("ssh", "auth_publickey_allow_any", fallback=False):
            log.msg(
                eventid="shellguard.login.success",
            ...
            log.msg(
                eventid="shellguard.login.failed",
...
class HoneypotPasswordChecker:
    ...
    def checkUserPass(self, theusername: bytes, thepassword: bytes, ip: str) -> bool:
        ...
        authclass = ShellGuardConfig.get("honeypot", "auth_class", fallback="UserDB")
        authmodule = "shellguard.core.auth"
